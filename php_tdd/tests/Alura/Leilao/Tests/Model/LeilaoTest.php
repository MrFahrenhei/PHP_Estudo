...
{
    public function testeLeilaoNaoDeveReceberLanceRepetido()
    {
        ...
        //static::assertEquals(1000, $leilao->getLances()[0]->valor);
    }
    public function testLeilaoNaoDeveAceitarMaisDe5Lances()
    {
        ...
        //static::assertEquals(5500, $leilao->getLances()[array_key_last($leilao->getLances())]->valor);
    }
    /**
    ...
    public function testLeilaoDeveReceberLances(int $qtdLances, Leilao $leilao, array $valores)
    {
        ...
        foreach ($valores as $i => $valorEsperado){
            static::assertEquals($valorEsperado, $leilao->getLances()[$i]->valor);
        }
    }
